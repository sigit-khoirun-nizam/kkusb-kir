...
<aside id="sidebar"
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" class="flex items-center gap-3">
            <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen" class="flex items-center gap-2">
                <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500 text-white font-black text-xl shadow-md shadow-brand-500/20">
                    K
                </div>
                <span class="text-2xl font-bold tracking-wider text-gray-900 dark:text-white">
                    KK<span class="text-brand-500">USB</span>
                </span>
            </div>
            <div x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen" 
                 class="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500 text-white font-black text-xl shadow-md shadow-brand-500/20">
                K
            </div>
        </a>
    </div>
