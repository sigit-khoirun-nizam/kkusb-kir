  ...
  <div class="space-y-6 max-w-3xl mx-auto">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Edit informasi kendaraan</p>
      </div>
      ...
      <form action="{{ route('kendaraan.update', $kendaraan) }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div>
            ...
            <input type="text" name="nomor_pintu" value="{{ old('nomor_pintu', $kendaraan->nomor_pintu) }}" required placeholder="BL268"
          ...
          <div>
            ...
            <input type="text" name="nopol" value="{{ old('nopol', $kendaraan->nopol) }}" required placeholder="B 1234 ABC"
              class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
          ...
          <div>
            ...
            <input type="text" name="jenis" value="{{ old('jenis', $kendaraan->jenis) }}" required placeholder="TRUK / MIXER / MOBIL"
              class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
          ...
          <div>
            ...
            <div x-data="{ isOptionSelected: true }" class="relative z-20 bg-transparent">
              <select name="status" required
                ...
                <option value="aktif" {{ old('status', $kendaraan->status) == 'aktif' ? 'selected' : '' }} class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Aktif</option>
                <option value="jatuh_tempo" {{ old('status', $kendaraan->status) == 'jatuh_tempo' ? 'selected' : '' }} class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Jatuh Tempo</option>
                <option value="terlambat" {{ old('status', $kendaraan->status) == 'terlambat' ? 'selected' : '' }} class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Terlambat</option>
                <option value="selesai" {{ old('status', $kendaraan->status) == 'selesai' ? 'selected' : '' }} class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Selesai</option>
              </select>
          ...
          <div class="sm:col-span-2">
            ...
            <textarea name="deskripsi" placeholder="Tulis keterangan kendaraan..." rows="3"
              class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">{{ old('deskripsi', $kendaraan->deskripsi) }}</textarea>
          ...
          <div class="sm:col-span-2 border-t border-gray-200 pt-4 dark:border-gray-800">
            <h3 class="text-md font-semibold text-gray-800 dark:text-white mb-4">Informasi KIR Aktif</h3>
          </div>
          ...
          <div>
            <x-form.date-picker 
              ...
              default-date="{{ old('exp_kir', $kendaraan->exp_kir ? $kendaraan->exp_kir->format('Y-m-d') : '') }}"
            />
          ...
          <div>
            ...
            <input type="text" name="no_pr" value="{{ old('no_pr', $kendaraan->no_pr) }}" placeholder="PR-XXXXX"
              class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
          ...
          <div>
            ...
            <input type="text" name="no_spk" value="{{ old('no_spk', $kendaraan->no_spk) }}" placeholder="SPK-XXXXX"
              class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
